...
public class ProfileService {
	...
	public List<ProfileDto> getFriendshipAndUser(Integer userId){
	...
	public List<ProfileDto> getRanking (Integer userid){
		List<ProfileDto> ranking = getFriendshipAndUser(userid);
	...
	public List<ProfileDto> getAllProfiles(){
		...
		for (Profile r : profiles) {
			...
			profileDto.setProfileImage(r.getProfileImage());
			result.add(profileDto);
		}
		return result;
	}
