...
import PuestaSol from '../../assets/cartaimg.jpg';
...
const CardRanking: React.FC = () => {
    ...
    return (
        <>
        <Nav />
        <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'flex-start', alignItems: 'flex-start', marginTop: '20px', backgroundImage: `url(${PuestaSol})` }}>
